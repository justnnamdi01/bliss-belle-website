...
// Import the same products array from product-grid
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-[#F5E6D3] flex items-center justify-center">
        <Header />
        <p className="text-2xl text-[#2C1810]">Product not found</p>
      </div>
    )
  }
      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="grid md:grid-cols-2 gap-12 bg-white rounded-3xl p-8 md:p-12 shadow-xl"
          >
            {/* Left Column - Image */}
            <div className="relative">
              <div className="relative aspect-square bg-gradient-to-b from-white to-gray-50 rounded-2xl p-8 flex items-center justify-center">
                {/* Floral decoration */}
                <motion.div
            ...
            <div className="flex flex-col">
              ...
              >
                <p className="text-[#5FACCE] text-sm font-serif mb-2 tracking-wider uppercase">
                  {product.brand}
                </p>
                <h1 className="font-serif text-3xl md:text-4xl text-[#2C5F7F] mb-6">
                  {product.name}
                </h1>
                <p className="text-4xl font-serif text-[#2C5F7F] mb-8">
                  ₹ {product.price.toFixed(2)}
                </p>

                {/* Benefits Section */}
                <div className="mb-8">
                  <h2 className="font-serif text-xl text-[#2C5F7F] mb-4">Key Benefits:</h2>
                  <ul className="space-y-3">
                    {product.benefits.map((benefit, index) => (
                      ...
                      >
                        <Check className="w-5 h-5 text-[#87CEEB] flex-shrink-0 mt-1" />
                        <span className="text-[#2C5F7F] text-sm leading-relaxed">
                          {benefit}
                        </span>
                      </motion.li>
                    ))}
                ...
                {/* Category Badge */}
                <div className="mb-8">
                  <span className="inline-block px-4 py-2 bg-[#B0E0E6] rounded-full text-sm text-[#2C5F7F] font-serif">
                ...
                <div className="mt-auto">
                  <AddToCartButton
                    ...
                    className="w-full bg-[#87CEEB] hover:bg-[#5FACCE] text-white py-4 text-lg"
                  />
                </div>
              </motion.div>
            </div>
