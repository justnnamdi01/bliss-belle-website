      ...
      <div className="pt-40 pb-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl md:text-2xl text-[#4A7C9E] mb-8">
            Our Hair Care collection is on its way! We're preparing something amazing for you.
          </p>
          <p className="text-lg text-[#2C5F7F] mb-12">
            Stay tuned for nourishing hair care products crafted with Ayurvedic wisdom.
          </p>
